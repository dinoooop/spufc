...
const images =[
    'http://127.0.0.1:8800/uploads/1717044305969-571005642.jpg',
    'http://127.0.0.1:8800/uploads/1716983586205-845245176.jpg',
    'http://127.0.0.1:8800/uploads/1717043338836-180953728.jpg',

    'http://127.0.0.1:8800/uploads/1717042995702-316224608.jpg',
...
export const dummyEvent = [
    {
        _id: 12,
        name: "Junior Football League",
        description: "The South Perth United Football Club was formed in 1981 with an initial membership of just 20 members.",
        logo: images[0],
        photos: [images[1], images[2]],
        start_at: "2024-06-01T20:47",
        type: "junior_club",
        website: "www.hpright2.com",
        phone: "+123 45562",
        address: "test address",
    ...
    {
        _id: 13,
        name: "Senior Teams League",
        description: "The South Perth United Football Club was formed in 1981 with an initial membership of just 20 members.",
        logo: images[3],
        photos: [images[4], images[5]],
        start_at: "2024-06-02T20:47",
        type: "social_club",
        website: "www.hpright2.com",
        phone: "+123 45562",
        address: "test address",
